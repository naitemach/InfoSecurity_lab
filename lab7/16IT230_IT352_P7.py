...
r = int(input("Enter r: "))
plaintext = input("Enter the cipher text: ")
...
for block in ptarr:
	...
	char = int(char,2)
	#C= (char**e) % n
	#print("cipher text sent by Alice: ",end="")
	#print(C)	
	mp = (char * (r ** e)) % n
	print("Message sent by eve is : ",end="")
	print(mp)
	sp = (mp ** d) % n
	print("Decrypted message sent back by bob is : ",end="")
	print(sp)
	s = (sp * ri) % n
	print("Message found by eve is : ",end="")
	print(s)
	#plain =  (s ** e) % n
	plain = s
	...
	plain = ''.join(plainarr)
	print("plain text found by eve is : ",end="'")
	print(plain,end="'\n")
	print()
